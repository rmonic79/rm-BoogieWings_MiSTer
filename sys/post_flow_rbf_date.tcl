...
#   output_files/rmBoogieWings.rbf -> output_files/rmBoogieWings_yyyymmdd.rbf
...
# il rmBoogieWings.rbf base (quello resta per l'upload MiSTer).

set out_dir "output_files"
set base    "rmBoogieWings"
