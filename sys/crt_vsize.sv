...
module crt_vsize #(
    ...
    always @(posedge clk) begin
        ...
        // wpx e' insieme indirizzo e CONTEGGIO dei pixel della riga (meta_px,
        // px_count_nat -> quanti pixel il read emette). Prima si fermava a
        // LINE_PX-1: con una riga di esattamente LINE_PX pixel (BW: 320) il
        // conteggio valeva 319 e l'ultima colonna a destra non veniva mai letta
        // (misurato sul flusso vero di BW, 2026-09-18). Ora conta fino a
        // LINE_PX e scrive solo finche' c'e' posto nello slot.
        if (pxl_cen & de_in & (wpx != LINE_PX)) begin
