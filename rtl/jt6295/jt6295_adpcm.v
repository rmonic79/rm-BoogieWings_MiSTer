...
(
    ...
    .din    ( en        ),
    .drop   ( en_V      ),
    .auto_ss_in ( auto_ss_in[3:0]  ),
    .auto_ss_out( auto_ss_out[3:0] ),
...
(
    ...
    .din    ( att       ),
    .drop   ( att_V     ),
    .auto_ss_in ( auto_ss_in[19:4]  ),
    .auto_ss_out( auto_ss_out[19:4] ),
    .auto_ss_wr ( auto_ss_wr        )
);
...
reg  signed [13:0] unlim_V;   // jotego 7d76b0b (16/08/2026): 12 bit con segno + 12 senza segno = 14 bit
