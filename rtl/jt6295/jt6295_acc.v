...
generate
    if( INTERPOL) begin
        ...
        assign sample    = cen4;
        // SATURA invece di troncare: se il FIR sfora i 14 bit, col troncamento il
        // picco si ribalta a fondo scala opposto (scatto). Costo: due comparatori.
        assign sound_out = ($signed(fir_dout) >  16'sd8191) ?  14'sd8191 :
                           ($signed(fir_dout) < -16'sd8192) ? -14'sd8192 :
                                                              fir_dout[13:0];
