...
module jt6295(
    ...
    // Savestate (auto_ss, modello F2). 359 bit = timing(17)+ctrl(102)+serial(172)+adpcm(68).
    // NON salvati: rom/acc (transitori) e pipeline adpcm (rigenerati in pochi cen).
    input      [358:0]     auto_ss_in,
    output     [358:0]     auto_ss_out,
    input                  auto_ss_wr
);
...
jt6295_timing u_timing(
    ...
    .cen_sr32   ( cen_sr32  ),
    .cen_48k    ( cen_48k   ),
    .auto_ss_in ( auto_ss_in[16:0]  ),
    .auto_ss_out( auto_ss_out[16:0] ),
...
jt6295_ctrl u_ctrl(
    ...
    .ack        ( ack           ),
    .zero       ( zero          ),
    .auto_ss_in ( auto_ss_in[118:17]  ),
    .auto_ss_out( auto_ss_out[118:17] ),
    .auto_ss_wr ( auto_ss_wr          )
);
...
jt6295_serial u_serial(
    ...
    .pipe_att   ( pipe_att      ),
    .pipe_data  ( pipe_data     ),
    .auto_ss_in ( auto_ss_in[290:119]  ),
    .auto_ss_out( auto_ss_out[290:119] ),
    .auto_ss_wr ( auto_ss_wr           )
);
...
jt6295_adpcm u_adpcm(
    ...
    .data       ( pipe_data     ),
    .sound      ( pipe_snd      ),
    .auto_ss_in ( auto_ss_in[358:291]  ),
    .auto_ss_out( auto_ss_out[358:291] ),
    .auto_ss_wr ( auto_ss_wr           )
);
