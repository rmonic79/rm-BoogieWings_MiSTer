...
module jt51_csr_op(
    ...
    output        [4:0] rate2,
    output        [3:0] rrate,
    // Savestate (auto_ss, modello F2). Register file operatori = reg0op(31*32=992) +
    // reg1op(11*32=352) = 1344 bit. [991:0]=reg0op, [1343:992]=reg1op.
    input      [1343:0] auto_ss_in,
    output     [1343:0] auto_ss_out,
    input               auto_ss_wr
);
...
jt51_sh #( .width(31), .stages(32)) u_reg0op(
    ...
    .din    ( reg0_in  ),
    .drop   ( reg0_out ),
    .auto_ss_in ( auto_ss_in[991:0]  ),
    .auto_ss_out( auto_ss_out[991:0] ),
...
jt51_sh #( .width(11), .stages(32), .rstval(1'b1)) u_reg1op(
    ...
    .din    ( reg1_in  ),
    .drop   ( reg1_out ),
    .auto_ss_in ( auto_ss_in[1343:992]  ),
    .auto_ss_out( auto_ss_out[1343:992] ),
    .auto_ss_wr ( auto_ss_wr            )
);
