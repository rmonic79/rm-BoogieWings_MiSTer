...
module jt51_pg(
    ...
    // Savestate (auto_ss, modello F2). u_phsh = fase per operatore = 20*29 = 580 bit.
    // u_pgrstsh (1x4) e' pipeline reset, NON salvato.
    input      [579:0]  auto_ss_in,
    output     [579:0]  auto_ss_out,
    input               auto_ss_wr
    `ifdef JT51_PG_SIM
...
jt51_sh #( .width(20), .stages(32-3) ) u_phsh(
    ...
    .din    ( ph_X      ),
    .drop   ( ph_VII    ),
    .auto_ss_in ( auto_ss_in  ),
    .auto_ss_out( auto_ss_out ),
