...
// TIMING: `next_cmd==CMD_ACTIVE` valutato IN PARALLELO al mux di priorita' invece
// che sulla sua uscita. Scegliere-e-confrontare da' lo stesso identico bit di
// confrontare-e-scegliere (il mux seleziona una sola sorgente), ma cosi' i
// confronti stanno sulle uscite dei banchi e la coda del cammino perde i livelli
// del mux. Era quella coda a rendere negativi SOLO sdram_a[12:11] (mai [10:0],
// che dal mux vanno dritti al registro). Portato da Night Slashers.
wire next_is_act =
        init    ? (init_cmd==CMD_ACTIVE) : (
