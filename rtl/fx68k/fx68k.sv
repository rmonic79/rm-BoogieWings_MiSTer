...
`endif	
	...
	excUnit excUnit( .Clks, .Nanod, .Irdecod, .enT1, .enT2, .enT3, .enT4,
		...
		.alue, .ccr,
		.dbg_d6(dbg_d6), .dbg_d7(dbg_d7),
		.dbg_d0(dbg_d0), .dbg_a0(dbg_a0), .dbg_a1(dbg_a1));
...
module excUnit( input s_clks Clks,
	...
	// Debug: expose D6/D7/D0/A0 for overlay
	output logic [31:0] dbg_d6,
	output logic [31:0] dbg_d7,
	output logic [31:0] dbg_d0,
	output logic [31:0] dbg_a0,
	output logic [31:0] dbg_a1);
...
// synthesis translate_on
	...
	// Debug exposure of D6/D7 (idx 6 and 7 in regs68)
	assign dbg_d6 = {regs68H[6], regs68L[6]};
	assign dbg_d7 = {regs68H[7], regs68L[7]};
	// D0 (idx 0) and A0 (idx 8) — RAM test diagnostic
	assign dbg_d0 = {regs68H[0], regs68L[0]};
	assign dbg_a0 = {regs68H[8], regs68L[8]};
	assign dbg_a1 = {regs68H[9], regs68L[9]};
	assign dbg_d2 = {regs68H[2], regs68L[2]};
	assign dbg_d3 = {regs68H[3], regs68L[3]};
...
module uRom( input clk, input [UADDR_WIDTH-1:0] microAddr, output logic [UROM_WIDTH-1:0] microOutput);
	...
	initial begin
		$readmemb("rtl/fx68k/microrom.mem", uRam);
	end
...
module nanoRom( input clk, input [NADDR_WIDTH-1:0] nanoAddr, output logic [NANO_WIDTH-1:0] nanoOutput);
	...
	initial begin
		$readmemb("rtl/fx68k/nanorom.mem", nRam);
	end
