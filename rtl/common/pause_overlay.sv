...
// Schermo 320 wide → ORIGIN_X = (320-240)/2 = 40. 24 row visibili, MSG_ROWS=70
// = le righe di logo/patrons.txt (il .mem e' 30 x MSG_ROWS word): 66 di lista
// piu' 4 vuote in fondo, lo stacco prima che lo scorrimento riparta da capo.
// =====================================================================
wire       patron_on;
